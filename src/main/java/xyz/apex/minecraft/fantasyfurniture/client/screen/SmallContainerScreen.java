...
public class SmallContainerScreen extends AbstractContainerScreen<SmallContainerMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(FantasyFurniture.MOD_ID, "textures/gui/container/small_storage.png");

    public SmallContainerScreen(SmallContainerMenu menu, Inventory playerInventory, Component title) {
        super(menu, playerInventory, title);
        this.imageWidth = 176;
        this.imageHeight = 166;
        // Adjust inventory label position below the 5-column container area
