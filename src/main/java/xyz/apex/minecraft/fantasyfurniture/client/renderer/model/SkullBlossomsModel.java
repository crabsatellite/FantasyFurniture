...
public final class SkullBlossomsModel extends Model {
    public static final ResourceLocation TEXTURE_SKELETON = ResourceLocation.fromNamespaceAndPath(
            FantasyFurniture.BONE_SKELETON_ID, "textures/block/decorations/skull_blossoms.png");
    public static final ResourceLocation TEXTURE_WITHER = ResourceLocation.fromNamespaceAndPath(
            FantasyFurniture.BONE_WITHER_ID, "textures/block/decorations/skull_blossoms.png");
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(FantasyFurniture.MOD_ID, "bone_skull_blossoms"), "main");

    private final ModelPart model;

    public SkullBlossomsModel(ModelPart root) {
        super(RenderType::entityTranslucentCull);
        this.model = root.getChild("bone_skull_blossoms");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone_skull_blossoms = partDefinition.addOrReplaceChild("bone_skull_blossoms", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        bone_skull_blossoms.addOrReplaceChild("vase", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(18, 15).addBox(-4.0F, -8.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(9, 16).addBox(3.0F, -8.0F, -4.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(0, 24).addBox(-4.0F, -8.0F, 3.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 6).addBox(-4.0F, -8.0F, -4.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition blossom = bone_skull_blossoms.addOrReplaceChild("blossom", CubeListBuilder.create(), PartPose.offset(0.0F, 2.0F, 0.0F));

        PartDefinition roots = blossom.addOrReplaceChild("roots",
                CubeListBuilder.create().texOffs(24, 28).addBox(-3.3866F, 3.857F, -3.1353F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(2.3866F, -17.857F, 2.1353F));
        ...
        PartDefinition skulls = blossom.addOrReplaceChild("skulls", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition leaves = blossom.addOrReplaceChild("leaves", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
